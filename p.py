...
CITIES=[
  "Pisa", "Lucca", "Pistoia", "Varese", "Cremona",
    "Cosenza", "Caltanissetta", "Avellino", "Trapani", "Benevento",
    "Brindisi", "Massa", "Carrara", "Asti", "L'Aquila",
    "Siena", "Grosseto", "Caserta", "Treviso", "Como",
    "Rovigo", "Lecco", "Chieti", "Viterbo", "Catanzaro",
    "Potenza", "Matera", "Frosinone", "Pavia", "Gela",
    "Mantua", "Agrigento", "Crotone", "Ragusa", "Bagheria", "Battipaglia", "Bitonto", "Casalnuovo di Napoli", "Castelfranco Veneto",
    "Cinisello Balsamo", "Collegno", "Desio", "Ercolano", "Gallarate",
    "Garbagnate Milanese", "Gela", "Giugliano in Campania", "Grugliasco", "Guidonia Montecelio",
    "Lamezia Terme", "Legnano", "Lentini", "Maddaloni", "Marano di Napoli",
    "Marino", "Melfi", "Modica", "Moncalieri", "Montebelluna",
    "Monterotondo", "Montesilvano", "Nettuno", "Nocera Inferiore", "Oristano",
    "Ostia", "Paternò", "Pomezia", "Pozzuoli", "Quarto",
    "Rho", "Rozzano", "San Benedetto del Tronto", "San Donà di Piave", "San Giorgio a Cremano",
    "San Severo", "Sassuolo", "Scandicci", "Senigallia", "Sesto Fiorentino",
    "Siena", "Torremaggiore", "Trani", "Velletri", "Voghera","Alessandria",
    "Biella", "Trapani", "Andria", "Barletta", "Civitanova Marche",
    "Seregno", "Faenza", "Aversa", "Carpi", "Imola",
    "Viareggio", "Foligno", "Tivoli", "Sanremo", "Castellammare di Stabia","Rome", "Milan", "Naples", "Turin", "Palermo",
    ...
    "Arezzo", "Udine", "Cesena", "La Spezia", "Lecce"
]
def is_tor_running():
